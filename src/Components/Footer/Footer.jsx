...
export default function Footer() {
  return (
    <section className='bg-gradient-to-r from-violet-300 to-indigo-600 w-full mt-4 h-[26rem] relative'>
        ...
        <a className=" flex w-36 bg-indigo-500 hover:bg-indigo-600 text-white py-2 px-4 rounded mt-4" href="/assets/pdf/Ioan-Flaviu-Resume.pdf" target="_blank" download="Ioan-Flaviu-Resume.pdf" >
            <p className='download_btn'>Download</p><img src={download}></img></a>
        </div>
